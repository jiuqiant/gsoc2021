...
def main(argv):
  ...
  if not flags.FLAGS.path_to_input_audio:
    raise ValueError('You must specify the path to the input audio.')
  ...
  ms.set_clip_data_path(bytes23(flags.FLAGS.path_to_input_audio), metadata)
